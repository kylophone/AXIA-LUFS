...
###How does this work?
PCM from each packet is converted to a series of 64-bit +1/-1 float, and handed to <a href = "https://github.com/jiixyj/libebur128">libebur128</a> for loudness measurement.
###To Do
